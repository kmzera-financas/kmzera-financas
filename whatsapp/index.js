...
create({
  ...
  client.onMessage(async (message) => {
    ...
    if (usuarioSnap.empty) {
      if (usuarioSnap.docs[0].data().banido) {
      console.log("❌ Número banido tentou usar o sistema:", telefone);
      return;
    }
      await client.sendText(message.from, "❌ Este número não está autorizado a usar o *KMZERA FINANÇAS*.

Por favor, entre em contato para se cadastrar.");
      return;
    }
